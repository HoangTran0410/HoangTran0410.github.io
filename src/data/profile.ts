...
export const PROFILE: Profile = {
  ...
  socials: [
    ...
    },
    {
      id: "facebook",
      label: "Facebook",
      url: "https://fb.com/9999.hoangtran",
      icon: "facebook",
    },
    {
      id: "linkedin",
      label: "LinkedIn",
      url: "https://linkedin.com/in/99-hoangtran",
      icon: "linkedin",
    },
    {
      id: "stackoverflow",
      label: "Stack Overflow",
      url: "https://stackoverflow.com/users/11898496",
      icon: "stack",
    },
    {
      id: "codepen",
      label: "CodePen",
      url: "https://codepen.io/hoanghien0410",
      icon: "codepen",
    },
  ...
  experience: [
    {
      ...
      highlights: [
        {
          vi: "Tham gia phát triển nhiều tính năng trong ứng dụng, từ miniapp tới native Android & iOS.",
          en: "Built multiple core features on MoMo app, from miniapp to native Android & iOS.",
        },
      ],
    },
  ],
